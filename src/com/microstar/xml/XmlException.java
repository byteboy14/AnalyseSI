 ...
 * information from &AElig;lfred's <code>error</code> callback. This is not
 * necessary for routine use of &AElig;lfred, but it is used by the optional
 * <code>HandlerBase</code> class.
 * <p>
 * Note that the core &AElig;lfred classes do <em>not</em> use this exception.
 *
