...
// $Id: XmlHandler.java,v 1.1 2008-03-02 00:22:50 lywoon Exp $
 ...
 * that implements this interface to receive the parsing events.
 * <p>
 * If you do not want to implement this entire interface, you can extend the
 * <code>HandlerBase</code> convenience class and then implement only what you
 * need.
 * <p>
...
public interface XmlHandler {
     ...
     * <p>
     * &AElig;lfred will call this method at the beginning of each external
     ...
     * <p>
     * &AElig;lfred will call this method at the end of each external entity,
     * including the top-level document entity and the external DTD subset.
     * <p>
     * If necessary, you can use this method to track the location of the
     * current entity so that you can resolve relative URIs correctly.
     *
     ...
     * <p>
     * &AElig;lfred will call this method when or if it encounters the document
     ...
     * Attribute.
     * <p>
     * &AElig;lfred will call this method once for each attribute (specified or
     * defaulted) before reporting a startElement event. It is up to your
     * handler to collect the attributes, if necessary.
     * <p>
     ...
     * Character data.
     * <p>
     * &AElig;lfred will call this method once for each chunk of character data
     * found in the contents of elements. Note that the parser may break up a
     * long sequence of characters into smaller chunks and call this method once
     * for each chunk.
     * <p>
     ...
     * <p>
     * &AElig;lfred will call this method once for each sequence of ignorable
     * whitespace in element content (never in mixed content).
     * <p>
     ...
     * <p>
     * &AElig;lfred will call this method whenever it encounters a serious
