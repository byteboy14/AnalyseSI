 ...
 * 02/09/2004 - 17:14:08
 *
 * FilterASIModule.java - Copyright (C) 2004 Dreux Loic dreuxl@free.fr
 *
 *
...
public abstract class FilterASIModule extends FilterModule {
    ...
    public FilterASIModule(String ID, AnalyseModule module,
                           ASIModuleHandler asiHandler) {
        super(ID, module);

        this.asiHandler = asiHandler;
    }
